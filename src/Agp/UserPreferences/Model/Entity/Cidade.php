...
namespace Agp\UserPreferences\Model\Entity;


use Agp\UserPreferences\Model\Observer\CidadeObserver;
...
class Cidade extends BaseModel
{
    ...
    {
        return $this->hasMany('Agp/UserPreferences/src/app', 'adm_pais_id');
    }
